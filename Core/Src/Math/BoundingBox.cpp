...
namespace Sapphire
{
	...
	void BoundingBox::Transform(const Matrix3x3& transform)
	{
	...
	BoundingBox BoundingBox::Transformed(const Matrix3x3& transform) const
	{
	...
	BoundingBox BoundingBox::Transformed(const Matrix3x4& transform) const
	{
		...
		Vector3 newEdge = Vector3(
			MathHelper::Abs(transform.m00_) * oldEdge.x_ + MathHelper::Abs(transform.m01_) * oldEdge.y_ + MathHelper::Abs(transform.m02_) * oldEdge.z_,
			MathHelper::Abs(transform.m10_) * oldEdge.x_ + MathHelper::Abs(transform.m11_) * oldEdge.y_ + MathHelper::Abs(transform.m12_) * oldEdge.z_,
			MathHelper::Abs(transform.m20_) * oldEdge.x_ + MathHelper::Abs(transform.m21_) * oldEdge.y_ + MathHelper::Abs(transform.m22_) * oldEdge.z_
			);
	...
	Rect BoundingBox::Projected(const Matrix4x4& projection) const
	{
