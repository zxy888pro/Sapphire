...
namespace Sapphire
{
	...
	Sapphire::Matrix4x4 Matrix4x4::operator*(const Matrix3x4& rhs) const
	{
		return Matrix4x4(
	...
	Sapphire::Quaternion Matrix4x4::GetRotation() const
	{
	...
	Sapphire::Matrix4x4 Matrix4x4::Inverse() const
	{
	...
	const Sapphire::Matrix4x4 Matrix4x4::IDENTITY;
