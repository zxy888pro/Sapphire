...
namespace Sapphire
{
	...
	public:
		...
		{
			return MathHelper::Abs(x_ * rhs.x_) + MathHelper::Abs(y_ * rhs.y_) + MathHelper::Abs(z_ * rhs.z_);
		}
		...
		Vector3 Abs() const { return Vector3(MathHelper::Abs(x_), MathHelper::Abs(y_), MathHelper::Abs(z_)); }
		...
		{
			return MathHelper::Equals(x_, rhs.x_) && MathHelper::Equals(y_, rhs.y_) && MathHelper::Equals(z_, rhs.z_);
		}

		/// Returns the angle between this vector and another vector in degrees.
		float Angle(const Vector3& rhs) const { return MathHelper::ACos(DotProduct(rhs) / (Length() * rhs.Length())); }

		/// Return whether is NaN.
		bool IsNaN() const { return MathHelper::IsNaN(x_) || MathHelper::IsNaN(y_) || MathHelper::IsNaN(z_); }
