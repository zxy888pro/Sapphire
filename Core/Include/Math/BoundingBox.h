...
namespace  Sapphire
{
	...
	class SAPPHIRE_CLASS BoundingBox
	{
	public:
		...
		BoundingBox Transformed(const Matrix3x3& transform) const;
		/// Return transformed by a 3x4 matrix.
		BoundingBox Transformed(const Matrix3x4& transform) const;
		/// Return projected by a 4x4 projection matrix.
		Rect Projected(const Matrix4x4& projection) const;
