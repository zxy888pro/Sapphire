...
namespace Sapphire
{
	...
	public:
		...
		{
			return MathHelper::Abs(x_ * rhs.x_) + MathHelper::Abs(y_ * rhs.y_) + MathHelper::Abs(z_ * rhs.z_) + MathHelper::Abs(w_ * rhs.w_);
		}

		/// Return absolute vector.
		Vector4 Abs() const { return Vector4(MathHelper::Abs(x_), MathHelper::Abs(y_), MathHelper::Abs(z_), MathHelper::Abs(w_)); }
		...
		{
			return MathHelper::Equals(x_, rhs.x_) && MathHelper::Equals(y_, rhs.y_) && MathHelper::Equals(z_, rhs.z_) && MathHelper::Equals(w_, rhs.w_);
		}

		/// Return whether is NaN.
		bool IsNaN() const { return MathHelper::IsNaN(x_) || MathHelper::IsNaN(y_) || MathHelper::IsNaN(z_) || MathHelper::IsNaN(w_); }
